...
CREATE TABLE payment (
    ...
    payment_date DATE,
    amount DECIMAL(10, 2),
    CONSTRAINT fk_payment FOREIGN KEY (user_ID) REFERENCES user(user_ID) ON DELETE CASCADE
);
...
INSERT INTO `travel_plan` (`travel_id`, `name`, `date`, `price`, `duration`, `availability`, `description`, `guide_id`, `hotel_id`, `estination`, `image1_url`, `image2_url`, `image3_url`) VALUES (NULL, 'discover bejaiaaaaa', '2023-05-01', '2000.00', '1', '1', 'this is a descriptionnn', NULL, NULL, 'bejaiaaaa', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80');

INSERT INTO `travel_plan` (`travel_id`, `name`, `date`, `price`, `duration`, `availability`, `description`, `guide_id`, `hotel_id`, `estination`, `image1_url`, `image2_url`, `image3_url`) VALUES (NULL, 'discover bejaia', '2023-05-01', '2000.00', '1', '1', 'helloo', NULL, NULL, 'bejaia', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80');

INSERT INTO `travel_plan` (`travel_id`, `name`, `date`, `price`, `duration`, `availability`, `description`, `guide_id`, `hotel_id`, `estination`, `image1_url`, `image2_url`, `image3_url`) VALUES (NULL, 'discover bejaia', '2023-05-01', '2000.00', '1', '1', 'this is a descriptionnnnnnnnnn', NULL, NULL, 'bejaia', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80', 'https://images.unsplash.com/photo-1630838788300-bf37622a54e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1527&q=80');
