...
if (isset($_GET['delete'])) {
    ...
    if ($conn->query($sql1) === TRUE) {
        header("Location: users.php"); // Redirect to hotels.php
        exit();
        } else {
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <a href="users.create.php" class="btn btn-primary" style="background-color: transparent; border-color: transparent; color: #337ab7;">Create New User</a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <a href="user.update.php?updateid='.$id.'" class="text-light" style="border: none; background-color: transparent; color: white; cursor: pointer;";">Update</a></button>';
                                                    echo ' | ';
