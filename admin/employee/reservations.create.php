...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO reservation (user_ID, travel_plan_id, reservation_date) VALUES ('$user_ID', '$travel_plan_id', '$reservation_date')";
                    ...
                    <div class="col-md-12">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_ID" placeholder = "please enter a valid ID" >
                            </div>
                            <div class="form-group">
