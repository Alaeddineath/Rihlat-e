...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO activity (activity_name, activity_date, activity_price, travel_plan_id, name_destination)
            VALUES ('$activity_name', '$activity_date', '$activity_price', '$travel_plan_id', '$name_destination')";
    ...
    <div class="col-md-12">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="activity_price" required >
            </div>
            <div class="form-group">
                <label for="travel_plan_id">Travel Plan ID:</label>
                <input type="text" class="form-control" name="travel_plan_id" required placeholder = "Please enter a valid ID" >
            </div>
            <div class="form-group">
                <label for="name_destination">Name Destination:</label>
                <input type="text" class="form-control" name="name_destination" required placeholder = "Please enter a valid Destination">
            </div>
